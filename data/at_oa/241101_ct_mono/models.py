...
def species_12_niche_13(t, f_dN1_1, f_dN2_13, f_dR12_1, f_dR2_3, params):

    def model(y, t, f_dN1_1, f_dN2_13, f_dR12_1, f_dR2_3, params):
        N1, N2, R1, R3 = y
        return [
            f_dN1_1(N1, R1, *params.values()),
    ...
    return odeint(
        ...
        xs,
        args=(f_dN1_1, f_dN2_13, f_dR12_1, f_dR2_3, params),
    )
