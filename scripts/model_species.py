...
class Chemostat():
    ...
    def __init__(self, name):
        self.species = {'at': Specie(0.302, 1/1.6*1.1933, 0.025, None),
                        'ct': Specie(0.255, 1/1.6*0.747, 0.025, None),
                        #'ms': Specie(0.38, 0.062, 0.025, None),
                        'oa': Specie(0.446, 1/1.6*0.69, 0.025, None)}
