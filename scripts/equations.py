...
# Symbols
equations = symbols(
    "dN1,dN2,dN12_1,dN12_2,dN12_13,dR1,dR2,dR3,J1_1,J1_2,J2_1,J2_2,J2_3,J2_13")

dN1, dN2, dN12_1, dN12_2, dN12_13, dR1, dR2, dR3, J1_1, J1_2, J2_1, J2_2, J2_3, J2_13 = equations
...
eq_J2_13 = Eq(J2_13, Min(v2_1 * R1 / (R1 + K2_1), v2_3 * R3 / (R3 + K2_3)))
#eq_J2_13 = Eq(J2_13, v2_1 * R1 / (R1 + K2_1) * v2_3 * R3 / (R3 + K2_3))
...
eq_dN2_13 = Eq(dN2, eq_J2_13.rhs * N2 - D * N2)
...
eq_dR12_13 = Eq(dR1,
                D * M1 - eq_J1_1.rhs * N1 / q1_1 - eq_J2_13.rhs * N2 / q2_1)
eq_dR2_3 = Eq(dR3,
...
f_dR12_13 = lambdify((N1, N2, R1, R3, *params.keys()), eq_dR12_13.rhs, "numpy")
